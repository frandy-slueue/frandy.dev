    ...
    <>
      <section className="hero-section">
        ...
        <div className="site-container hero-content">
          <motion.p className="hero-eyebrow" variants={fadeUp} initial="hidden" animate="visible" transition={{ duration: 0.6, delay: 0.1 }}>
            Portfolio — 2025
          </motion.p>

          <motion.h1 className="hero-name" variants={fadeUp} initial="hidden" animate="visible" transition={{ duration: 0.6, delay: 0.2 }}>
            Frandy <span className="hero-name__accent">Slueue</span>
          </motion.h1>
