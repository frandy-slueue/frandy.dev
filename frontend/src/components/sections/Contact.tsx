...
const LINKS = [
  {
    ...
    label: "LinkedIn",
    value: "linkedin.com/in/frandy-slueue",
    href: "https://linkedin.com/in/frandy-slueue",
  },
  {
    icon: <FaGithub size={18} />,
    label: "GitHub",
    value: "github.com/frandy-slueue",
    href: "https://github.com/frandy-slueue",
  },
];
